...
function calcular() {
    ...
    if (fcm != '') {
        if (fcr != '') {
            ...
            document.getElementById('lbl_FCT').className = "fct_visible text-sm font-medium text-white px-2";
            ...
            document.getElementById('divfct').className = "block px-2 py-2 mx-2 border-2 rounded-md bg-slate-800";
